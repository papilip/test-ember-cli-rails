...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post platforms_url, params: { platform: { api_key: @platform.api_key, comment: @platform.comment, licence: @platform.licence, name: @platform.name } }, as: :json
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { api_key: @platform.api_key, comment: @platform.comment, licence: @platform.licence, name: @platform.name } }, as: :json
    assert_response 200
  end
